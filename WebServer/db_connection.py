...
class DatabaseCon(object):
    ...
    def get_users_from_race(self, race_id):
        d = "SELECT * from races WHERE race_id = '{}'".format(race_id)
        self.cur.execute(d)
        return self.cur.fetchall()
    ...
    def get_circuit_from_id(self, circuit_id):
        d = "SELECT * from circuits WHERE circuit_id = '{}'".format(circuit_id)
        self.cur.execute(d)
        return self.cur.fetchall()
